var arr = ["BUHO","COLECCIONISTA","ESPIRAL","COMIDA","JUGUETES","AMIGOS","PERRO","GATO","CANECA","ARROZ","FRIJOL","GENTE","HUMANIDAD","HUMANO","PERSONA","GENTE","HOMBRE","MUJER","BEBE","NIÑO","NIÑA","ADOLESCENTE","ADULTO","ADULTA","ANCIANO","ANCIANA","DON","DOÑA","SEÑOR","SEÑORA","CABALLERO","DAMA","INDIVIDUO","CUERPO","HUMANO","SALUD","CUERPO","PIERNA","PIE","TALON","ESPINILLA","RODILLA","MUSLO","CABEZA","CARA","BOCA","LABIO","DIENTE","OJO","NARIZ","BARBA","BIGOTE","CABELLO","OREJA","CEREBRO","ESTOMAGO","BRAZO","CODO","HOMBRO","UÑA","MANO","MUÑECA","PALMA","DEDO","TRASERO","COLA","GLUTEOS","ABDOMEN","HIGADO","MUSCULO","CUELLO","CORAZON","MENTE","ALMA","ESPIRITU","PECHO","CINTURA","CADERA","ESPALDA","SANGRE","CARNE","PIEL","HUESO","RESFRIADO","GRIPE","DIARREA","SALUD","ENFERMEDAD","FAMILIA","AMIGO","AMIGA","CONOCIDO","CONOCIDA","COLEGA","PAREJA","ESPOSO","ESPOSA"];
var intentos = 10;
var sel = [];
var ctrl = false;
var rValue;
...
function guarda(p){
    ...
    arr[arr.length] = p;
    /*Activar key event e iniciar el juego*/
    ctrl = true;
    jugar();
}
function jugar(){
...
function getLetter(valor){
    ...
    if(sel.indexOf(valor) >= 0){
        ...
        document.getElementById('puestas').style.display = "contents";
        document.getElementById('puestas').innerHTML = badWord.join(" ").toString();
        }
        /* get canvas */
        var canvas = document.getElementById("cvDraw");
        ctx.beginPath();
